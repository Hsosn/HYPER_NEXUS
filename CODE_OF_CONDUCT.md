...
where the project is discussed — and also applies when an individual is
...
address listed in `MAINTAINERS.md`, or via a private message to the most active
committer on GitHub. **All complaints will be reviewed and investigated
promptly and fairly.**
